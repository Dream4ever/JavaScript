...
临时的解决方案：先将服务端放到和客户端相同的域名下，还真 OK 了！注意，这种情况下， Node.js 服务端是参考下面的方式配置的。后来解决了跨域问题之后（看[另一篇文章](https://hewei.in/business/cross-origin.html)），就不需要用 IISNode 管理 Node.js 服务了，又可以一门心思写 JS 不用管 IIS 了，哈哈。
...
见文章：[解决跨域问题](https://hewei.in/business/cross-origin.html)。
